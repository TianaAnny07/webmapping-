...
function VisitorApp() {
  ...
  const handleValidateRoute = useCallback(() => {
    ...
    startWatch();
    setAlert({ 
      message: `Navigation démarrée vers ${selectedFacility.properties.name || "l'établissement"}.`, 
      variant: 'success' 
    });
  ...
  // Gestion du statut du guidage vocal
  const handleVoiceStatusChange = useCallback((active) => {
    console.log('Guidage vocal actif:', active);
  }, []);

  // Activer le mode "mesurer une distance"
